...
def run_eval(
    ...
    iterator = range(min(10,len(dataloader)))
    with torch.no_grad():
...
if __name__ == "__main__":
    ...
    datapath = '/data0/amax/git/MCSD/dataset/wmt_ende.json'

    parser = argparse.ArgumentParser()
    parser.add_argument(
        "--draft-model", type=str,  help="Draft model path.", default= vicuna160m
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--datapath", type=str,  help="The json data file." ,default= datapath
    )
